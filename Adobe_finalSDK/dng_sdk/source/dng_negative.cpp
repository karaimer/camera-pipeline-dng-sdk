	...
	public:
		...
		virtual void Start (uint32 threadCount,
			...
			if (tileSize != fUnitCell)
				{
				// hakki can karaimer commentted out or edited .
				//ThrowProgramError ();
				}
		...
		if (!IsMonochrome ())
			...
			if (ColorimetricReference () == crICCProfilePCS)
				...
				if (shared.fAsShotNeutral.Count () == ColorChannels ())
					{
					//hakki can commented out or edited 
					//SetCameraNeutral (shared.fAsShotNeutral);
					//std::fstream myfile("D:\\wb.txt", std::ios_base::in);

					////hakki can commented out or edited 
					//SetCameraNeutral (shared.fAsShotNeutral);

					int pipeline_settings [4] = { 0, 0, 0, 0 };

					std::fstream settingsfile(".\\wbAndGainSettings.txt", std::ios_base::in);

					real32 value;
					settingsfile >> value;					
					pipeline_settings [0] = real32(value);

					settingsfile >> value;					
					pipeline_settings [1] = real32(value);

					settingsfile >> value;					
					pipeline_settings [2] = real32(value);

					settingsfile >> value;					
					pipeline_settings [3] = real32(value);
					settingsfile.close();

					if(pipeline_settings [2] == 0 & pipeline_settings [3] == 1){

						std::fstream wbfile(".\\wb.txt", std::ios_base::in);

						real32 value;
						wbfile >> value;					
						shared.fAsShotNeutral [0] = real32(value);

						wbfile >> value;
						shared.fAsShotNeutral [1] = real32(value);

						wbfile >> value;
						shared.fAsShotNeutral [2] = real32(value);
						wbfile.close();

						SetCameraNeutral (shared.fAsShotNeutral);										
					}
					if(pipeline_settings [2] == 1 & pipeline_settings [3] == 0){
						SetCameraNeutral (shared.fAsShotNeutral);										
					}
						//htc 65k ok
						//dng_vector n (3);	
						//n [0] = 0.527678588041226;
						//n [1] = 1.0000;
						//n [2] = 0.656258773642387;
						//SetCameraNeutral (n);

						//samsung 65k  ok
						//dng_vector n (3);	
						//n [0] = 0.450700053638860;
						//n [1] = 1.0000;
						//n [2] = 0.706476676865889;
						//SetCameraNeutral (n);										

						//motorola nexus6 65k  ok
						//dng_vector n (3);	
						//n [0] = 0.475587351043601;
						//n [1] = 1.0000;
						//n [2] = 0.712798038039884;
						//SetCameraNeutral (n);				

						//lg g4 65k  ok
						//dng_vector n (3);	
						//n [0] = 0.416121130289412;
						//n [1] = 1.0000;
						//n [2] = 0.713481081159497;
						//SetCameraNeutral (n);		

						////samsung 35k ok
/*						dng_vector n (3);	
						n [0] = 0.743867084657952;
						n [1] = 1.0000;
						n [2] = 0.446253144815890;
						SetCameraNeutral (n);		*/								

						////lg g4 35k ok 
						//dng_vector n (3);	
						//n [0] = 0.772192701495725;
						//n [1] = 1.0000;
						//n [2] = 0.439774783776197;
						//SetCameraNeutral (n);										

						////motorola nexus 35k ok
						//dng_vector n (3);	
						//n [0] = 0.778840284742435;
						//n [1] = 1.0000;
						//n [2] = 0.435891512437270;
						//SetCameraNeutral (n);										

						//htc m9 35k ok
						//dng_vector n (3);	
						//n [0] = 0.775735666543166;
						//n [1] = 1.0000;
						//n [2] = 0.443242949347019;
						//SetCameraNeutral (n);										

						//lg g4 25k  ok
						//dng_vector n (3);	
						//n [0] = 1.01918624689654;
						//n [1] = 1.0000;
						//n [2] = 0.349165848145552;
						//SetCameraNeutral (n);		

						////samsung 25k ok
						//dng_vector n (3);	
						//n [0] = 0.948167526195896;
						//n [1] = 1.0000;
						//n [2] = 0.361478105890309;
						//SetCameraNeutral (n);				

						////motorola nexus 25k ok
						//dng_vector n (3);	
						//n [0] = 1.01587695786134;
						//n [1] = 1.0000;
						//n [2] = 0.340856599583250;
						//SetCameraNeutral (n);										

						//htc m9 25k ok
						//dng_vector n (3);	
						//n [0] = 0.961925461925796;
						//n [1] = 1.0000;
						//n [2] = 0.370881556041147;
						//SetCameraNeutral (n);										

						////motorola nexus 3k ok
						//dng_vector n (3);	
						//n [0] = 0.675391309645981;
						//n [1] = 1.0000;
						//n [2] = 0.532111685619839;
						//SetCameraNeutral (n);		

						//htc m9 3k ok
						//dng_vector n (3);	
						//n [0] = 0.606826060857872;
						//n [1] = 1.0000;
						//n [2] = 0.542958513319382;
						//SetCameraNeutral (n);		

						////samsung 3k ok
						//dng_vector n (3);	
						//n [0] = 0.479392100886193;
						//n [1] = 1.0000;
						//n [2] = 0.541183040141217;
						//SetCameraNeutral (n);				

						//lg g4 3k  ok
						//dng_vector n (3);	
						//n [0] = 0.642878758785645;
						//n [1] = 1.0000;
						//n [2] = 0.543432091272817;
						//SetCameraNeutral (n);		


///////////////////////////colorfulchart chart5
						////motorola nexus 3k_v2 okk
						//dng_vector n (3);	
						//n [0] = 0.631483502083572;
						//n [1] = 1.0000;
						//n [2] = 0.551816796513764;
						//SetCameraNeutral (n);		

						//htc m9 3k_v2 okk
						//dng_vector n (3);	
						//n [0] = 0.697436424863759;
						//n [1] = 1.0000;
						//n [2] = 0.525747164438716;
						//SetCameraNeutral (n);		

						////samsung 3k_v2 okk
						//dng_vector n (3);	
						//n [0] = 0.654692251041387;
						//n [1] = 1.0000;
						//n [2] = 0.542753391199285;
						//SetCameraNeutral (n);				

						//lg g4 3k_v2  okk
						//dng_vector n (3);	
						//n [0] = 0.477712136326141;
						//n [1] = 1.0000;
						//n [2] = 0.553731969614402;
						//SetCameraNeutral (n);		
////////////////////////////
///////////////////////////colorfulchart chart6
						////motorola nexus 3k_v2 okk
						//dng_vector n (3);	
						//n [0] = 0.575502085946185;
						//n [1] = 1.0000;
						//n [2] = 0.562712621501103;
						//SetCameraNeutral (n);		

						//htc m9 3k_v2 okk
						//dng_vector n (3);	
						//n [0] = 0.699749075212822;
						//n [1] = 1.0000;
						//n [2] = 0.498824263825179;
						//SetCameraNeutral (n);		

						////samsung 3k_v2 okk
						//dng_vector n (3);	
						//n [0] = 0.663108187168620;
						//n [1] = 1.0000;
						//n [2] = 0.539699778179517;
						//SetCameraNeutral (n);				

						//lg g4 3k_v2  okk
						//dng_vector n (3);	
						//n [0] = 0.656897894766208;
						//n [1] = 1.0000;
						//n [2] = 0.526710493823195;
						//SetCameraNeutral (n);		
////////////////////////////
///////////////////////////colorfulchart chart6
						//motorola nexus flourescent okk
						//dng_vector n (3);	
						//n [0] = 0.755265010484796;
						//n [1] = 1.0000;
						//n [2] = 0.440773848844011;
						//SetCameraNeutral (n);		

						//htc m9 flourescent okk
						//dng_vector n (3);	
						//n [0] = 0.739674990832947;
						//n [1] = 1.0000;
						//n [2] = 0.408418720853278;
						//SetCameraNeutral (n);		

						////samsung flourescent okk
						//dng_vector n (3);	
						//n [0] = 0.693016071697102;
						//n [1] = 1.0000;
						//n [2] = 0.455818309894332;
						//SetCameraNeutral (n);				

						////lg g4 flourescent okk
						//dng_vector n (3);	
						//n [0] = 0.755901070700584;
						//n [1] = 1.0000;
						//n [2] = 0.422205467963665;
						//SetCameraNeutral (n);		
////////////////////////////
///////////////////////////colorfulchart chart5
						//motorola nexus flourescent okk
						//dng_vector n (3);	
						//n [0] = 0.797833633903427;
						//n [1] = 1.0000;
						//n [2] = 0.436676408984714;
						//SetCameraNeutral (n);		

						//htc m9 flourescent okk
						//dng_vector n (3);	
						//n [0] = 0.757291542247171;
						//n [1] = 1.0000;
						//n [2] = 0.430990101056395;
						//SetCameraNeutral (n);		

						//samsung flourescent okk
						//dng_vector n (3);	
						//n [0] = 0.694550991895530;
						//n [1] = 1.0000;
						//n [2] = 0.444684224121980;
						//SetCameraNeutral (n);				

						//lg g4 flourescent okk
						//dng_vector n (3);	
						//n [0] = 0.748055838777253;
						//n [1] = 1.0000;
						//n [2] = 0.424091075599007;
						//SetCameraNeutral (n);		
////////////////////////////
///////////////////////////colorfulchart chart5
						//motorola nexus outdoor okk
						//dng_vector n (3);	
						//n [0] = 0.557029456540473;
						//n [1] = 1.0000;
						//n [2] = 0.646384289613770;
						//SetCameraNeutral (n);		

						//htc m9 outdoor okk
						//dng_vector n (3);	
						//n [0] = 0.558382962214052;
						//n [1] = 1.0000;
						//n [2] = 0.593084145627122;
						//SetCameraNeutral (n);		

						//samsung outdoor okk
						//dng_vector n (3);	
						//n [0] = 0.518304251852131;
						//n [1] = 1.0000;
						//n [2] = 0.634864719827835;
						//SetCameraNeutral (n);				

						//lg g4 outdoor okk
						//dng_vector n (3);	
						//n [0] = 0.526679999085253;
						//n [1] = 1.0000;
						//n [2] = 0.625977551134067;
						//SetCameraNeutral (n);		
////////////////////////////
///////////////////////////colorfulchart chart6
						//motorola nexus outdoor okk
						//dng_vector n (3);	
						//n [0] = 0.562023927899675;
						//n [1] = 1.0000;
						//n [2] = 0.639514298542094;
						//SetCameraNeutral (n);		

						//htc m9 outdoor okk
						//dng_vector n (3);	
						//n [0] = 0.552902557662818;
						//n [1] = 1.0000;
						//n [2] = 0.609319747866036;
						//SetCameraNeutral (n);		

						//samsung outdoor okk
						//dng_vector n (3);	
						//n [0] = 0.517082994834408;
						//n [1] = 1.0000;
						//n [2] = 0.637051921054495;
						//SetCameraNeutral (n);				

						//lg g4 outdoor okk
						//dng_vector n (3);	
						//n [0] = 0.526460316390219;
						//n [1] = 1.0000;
						//n [2] = 0.621786070662412;
						//SetCameraNeutral (n);		
////////////////////////////
///////////////////////////xrite colorchart 3k srgb comparison
						//motorola nexus 3k okk
						//dng_vector n (3);	
						//n [0] = 0.729231445504875;
						//n [1] = 1.0000;
						//n [2] = 0.522273796286139;
						//SetCameraNeutral (n);

						//htc m9 3k okk
						//dng_vector n (3);	
						//n [0] = 0.689059234154694;
						//n [1] = 1.0000;
						//n [2] = 0.527106933298689;
						//SetCameraNeutral (n);		

						//samsung 3k okk
						//dng_vector n (3);	
						//n [0] = 0.588890013896515;
						//n [1] = 1.0000;
						//n [2] = 0.550563618045809;
						//SetCameraNeutral (n);				

						//lg g4 3k okk
						//dng_vector n (3);	
						//n [0] = 0.667559272627896;
						//n [1] = 1.0000;
						//n [2] = 0.539520540737496;
						//SetCameraNeutral (n);		
////////////////////////////
///////////////////////////xrite colorchart flourescent srgb comparison
						//motorola nexus flourescent okk
						//dng_vector n (3);	
						//n [0] = 0.761521514425347;
						//n [1] = 1.0000;
						//n [2] = 0.419406477670399;
						//SetCameraNeutral (n);

						//htc m9 flourescent okk
						//dng_vector n (3);	
						//n [0] = 0.749816720279922;
						//n [1] = 1.0000;
						//n [2] = 0.431003537627681;
						//SetCameraNeutral (n);		

						//samsung flourescent okk
						//dng_vector n (3);	
						//n [0] = 0.694474891373588;
						//n [1] = 1.0000;
						//n [2] = 0.441512050534827;
						//SetCameraNeutral (n);				

						//lg g4 flourescent okk
						//dng_vector n (3);	
						//n [0] = 0.737756590052634;
						//n [1] = 1.0000;
						//n [2] = 0.423814999802423;
						//SetCameraNeutral (n);		
////////////////////////////

///////////////////////////xrite colorchart outdoor srgb comparison
						//motorola nexus okk
						//dng_vector n (3);	
						//n [0] = 0.617014921453501;
						//n [1] = 1.0000;
						//n [2] = 0.556609413161307;
						//SetCameraNeutral (n);

						//htc m9  okk
						//dng_vector n (3);	
						//n [0] = 0.615089325848790;
						//n [1] = 1.0000;
						//n [2] = 0.546165895833231;
						//SetCameraNeutral (n);		

						//samsung okk
						//dng_vector n (3);	
						//n [0] = 0.536570443344819;
						//n [1] = 1.0000;
						//n [2] = 0.576984104695346;
						//SetCameraNeutral (n);				

						//lg g4 okk
						//dng_vector n (3);	
						//n [0] = 0.578978788452886;
						//n [1] = 1.0000;
						//n [2] = 0.567987823013494;
						//SetCameraNeutral (n);		
////////////////////////////

//dummy wb.
						//dng_vector n (3);	
						//n [0] = 0.629903635040267;
						//n [1] = 1.0000;
						//n [2] = 0.533769747025026;
						//SetCameraNeutral (n);		
...
void dng_negative::BuildStage2Image (dng_host &host)
	...
	std::fstream myfile(".\\wbAndGainSettings.txt", std::ios_base::in);
	...
	if(pipeline_settings [0] == 1 & pipeline_settings [1] == 0){
...
void dng_negative::DoInterpolateStage3 (dng_host &host,
	...
	//// hakki can karaimercommented 
	//dng_rect srcBounds = stage2.Bounds ();
